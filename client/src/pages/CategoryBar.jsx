...
const Categorybar = () => {
    return (
        <>
            <div className="border border-b border-primary"></div>
            <div className="overflow-x-auto">
                <div className="flex font-semibold gap-3 px-4 m-2 rounded-2xl justify-center">
                    {productCategory.map((cat) => (
                        <div className="flex cursor-pointer border border-primary gap-2 p-2 m-2 rounded-2xl shadow-md hover:bg-primary/80">
